(ns propagators.tui.graph.compiler-2-versioned-tui
  ...
  (:require [charm.components.text-input :as text-input]
            ...
            [propagators.tui.graph.compiler-2-tui :as legacy-tui]
            [propagators.tui.graph.compiler-2-versioned-tui.editor :as editor]
            [propagators.tui.graph.compiler-2-versioned-tui.layout :as layout]
