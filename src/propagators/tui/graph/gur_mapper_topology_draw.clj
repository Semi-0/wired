(ns propagators.tui.graph.gur-mapper-topology-draw
  ...
  (:require [clojure.pprint :as pprint]
            ...
            [propagators.infra.gur.accumulating :as acc]
            [propagators.infra.gur.accumulating.runner.instrumentation :as runner-instr]
...
(defn -main
  ...
  (let [depth (Long/parseLong (or (first args) "6"))
        ...
        frame-path (str out-prefix depth "-frame-propagators.tui.graph.txt")
