...
(ns propagators.tui.graph.vijual
  (:require [propagators.tui.graph.vijual.layout :as layout]
            [propagators.tui.graph.vijual.render :as render])
  (:import (java.io File)
...
(defn draw-graph-comparison
  "Prints grid-swap, force-directed snapped, and Sugiyama layered layouts for the same propagators.tui.graph."
  ([edges nodes opts]
...
(defn draw-directed-graph-comparison
  "Prints current directed, force-directed, and Sugiyama layered layouts for the same directed propagators.tui.graph."
  ([edges nodes opts]
