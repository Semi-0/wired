(ns propagators.tui.graph.vijual.layout.stress
  (:require [propagators.tui.graph.vijual.math :as m]))

(defn layout-fn [name]
  (deref (requiring-resolve (symbol "propagators.tui.graph.vijual.layout" (str name)))))
