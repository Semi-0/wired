(ns graph.compiler-2-runtime.instance-replay-test
  (:require [clojure.test :refer [deftest is testing]]
            [graph.compiler-2-runtime :as runtime]
            [graph.compiler-2-runtime.effects :as effects]
            [graph.compiler-2-runtime.instance-replay :as replay]
...
(def fixture-path
  "test/graph/compiler_2_runtime/fixtures/four_edits.json")
