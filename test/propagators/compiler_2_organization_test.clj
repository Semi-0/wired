(ns propagators.compiler-2-organization-test
  (:require [clojure.test :refer [deftest is]]
            ...
            [propagators.compiler-2.deprecated.legacy-core :as legacy-core]
            [propagators.compiler-2.deprecated.compiler-core :as compiler-shim]
...
(deftest deprecated-compilers-remain-source-compatible
  (is (:deprecated
       (meta (find-ns 'propagators.compiler-2.deprecated.legacy-core))))
  (is (:deprecated (meta (find-ns
                          'propagators.compiler-2.deprecated.compiler-core))))
